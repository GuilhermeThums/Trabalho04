...
public class MainActivity extends AppCompatActivity {
    ...
    public void entrarApp(View v) {
        ...
        if (TextUtils.isEmpty(loginTexto.trim())) {
            Toast.makeText(this, "Usuario vazio!", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(senhaTexto.trim())) {
            Toast.makeText(this, "Senha vazio", Toast.LENGTH_SHORT).show();
